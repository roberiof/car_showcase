        ...
        <div className='search-manufacturer'>
          <Combobox value={manufacturer} onChange={setManufacturer}>
            <div className='relative w-full'>
              {/* Button for the seeing the complete dropdown */}
                      ...
                      >
                        {({ selected, active }) => (
                          <>
                            ...
                            {selected ? (
                              <span className={`absolute inset-y-0 left-0 flex items-center pl-3 ${active? "text-white": "text-primary-blue bg-primary-purple"}`}
                              ></span>
                            ) : null}
                          </>
                        )}
